...
using TruePower.Items.Weapons;
using Microsoft.Xna.Framework;
using Terraria;
using Terraria.ID;
using Terraria.ModLoader;

namespace TruePower.Projectiles
{
    public class DirtJavelinProjectile : ModProjectile
    {
        ...
        // Here's an Dirt on how you could make your AI even more readable, by giving AI fields more descriptive names
        ...
        {
            // If you'd use the Dirt above, you'd do: isStickingToTarget = 1f;
